...
public class ResumeTestData {
    public static void main(String[] args) {
        ...
        List<Organization> education = Arrays.asList(new Organization("Заочная физико-техническая школа при МФТИ", "http://www.school.mipt.ru/", Arrays.asList(new Organization.Period(LocalDate.of(1984, 9, 1), LocalDate.of(1987, 6, 1), "Студент", ""))));
        resume.setSection(SectionType.EDUCATION, new OrganizationSection(education));
    }
    public static Resume resumeFiller(String uuid, String fullName) {
